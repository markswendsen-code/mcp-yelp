...
let session: YelpSession | null = null;
  ...
  try {
    ...
    switch (name) {
      case "yelp_search_restaurants":
        return { content: [{ type: "text", text: JSON.stringify(await session.searchRestaurants(args as any), null, 2) }] };
      case "yelp_search_businesses":
        return { content: [{ type: "text", text: JSON.stringify(await session.searchBusinesses(args as any), null, 2) }] };
      case "yelp_get_business_details":
        return { content: [{ type: "text", text: JSON.stringify(await session.getBusinessDetails(args?.businessId as string), null, 2) }] };
      case "yelp_get_reviews":
        return { content: [{ type: "text", text: JSON.stringify(await session.getReviews(args?.businessId as string, args as any), null, 2) }] };
      case "yelp_get_photos":
        return { content: [{ type: "text", text: JSON.stringify(await session.getPhotos(args?.businessId as string, args as any), null, 2) }] };
      case "yelp_get_menu":
        return { content: [{ type: "text", text: JSON.stringify(await session.getMenu(args?.businessId as string), null, 2) }] };
      case "yelp_get_hours":
        return { content: [{ type: "text", text: JSON.stringify(await session.getHours(args?.businessId as string), null, 2) }] };
      case "yelp_find_similar":
        return { content: [{ type: "text", text: JSON.stringify(await session.findSimilar(args?.businessId as string, args?.limit as number), null, 2) }] };
      case "yelp_get_trending":
        return { content: [{ type: "text", text: JSON.stringify(await session.getTrending(args?.location as string, args?.category as string), null, 2) }] };
      case "yelp_get_collections":
        return { content: [{ type: "text", text: JSON.stringify(await session.getCollections(args?.location as string, args?.category as string), null, 2) }] };
      case "yelp_check_wait_time":
        return { content: [{ type: "text", text: JSON.stringify(await session.checkWaitTime(args?.businessId as string), null, 2) }] };
      case "yelp_get_deals":
        return { content: [{ type: "text", text: JSON.stringify(await session.getDeals(args?.location as string, args?.category as string), null, 2) }] };
      default:
